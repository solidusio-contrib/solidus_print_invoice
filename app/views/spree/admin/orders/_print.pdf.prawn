...
@font_face = SolidusPrintInvoice::Config[:print_invoice_font_face]

font @font_face

im = Rails.application.assets.find_asset(SolidusPrintInvoice::Config[:print_invoice_logo_path])
...
if SolidusPrintInvoice::Config.use_sequential_number? && @order.invoice_number.present? && !@hide_prices
